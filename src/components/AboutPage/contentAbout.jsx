    ...
    <div className="content-container">
      <div className="contentAbout" id="ContentAbout">
        ...
        <p className="about-para2">
          This FDP is mainly focused on brushing up the basics as well as
          bringing out the research being carried out around the globe about the
          applications in different domains. This FDP will introduce the basics
          of Linear Algebra at a post graduate level and also showcase
